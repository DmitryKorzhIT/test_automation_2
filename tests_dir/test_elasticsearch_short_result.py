...
def test_1():
    ...
    file_name = elasticsearch_short_result.create_report_file(test_name='elasticsearch_short_result_error_404',
                                                              header=header)
    ...
    for search_query in search_queries:
        ...
        flag_local = elasticsearch_short_result.check_pages_elasticsearch(file_name=file_name,
